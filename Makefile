game: main.o logic.o output.o
	cc main.o logic.o output.o -o game.out ; ./game.out

leaderboard_test: test_leaderboard.o output.c
	cc test_leaderboard.o output.c -o leaderboard_test.out; ./leaderboard_test.out

function_test: test_function.o logic.o
	cc test_function.o logic.o -o function_test.out; ./function_test.out
